...
import com.kaanburaksener.octoUML.src.model.edges.MessageEdge;
import com.kaanburaksener.octoUML.src.model.nodes.SequenceObject;
...
public class SequenceDiagramController extends AbstractDiagramController {
    ...
    private void initToolBarActions() {
        ...
        Image image = new Image("com/kaanburaksener/octoUML/src/icons/seqObject.png");
        createBtn.setGraphic(new ImageView(image));
        createBtn.setText("");

        image = new Image("com/kaanburaksener/octoUML/src/icons/message.png");
