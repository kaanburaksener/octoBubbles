...
import com.kaanburaksener.octoUML.src.controller.dialog.EdgeEditDialogController;
import com.kaanburaksener.octoUML.src.controller.dialog.MessageEditDialogController;
import com.kaanburaksener.octoUML.src.model.edges.*;
import com.kaanburaksener.octoUML.src.util.commands.DirectionChangeEdgeCommand;
import com.kaanburaksener.octoUML.src.util.commands.MoveMessageCommand;
import com.kaanburaksener.octoUML.src.util.commands.ReplaceEdgeCommand;
...
import com.kaanburaksener.octoUML.src.view.nodes.SequenceObjectView;
    ...
    */
    ...
    public boolean showEdgeEditDialog(AbstractEdge edge) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("com/kaanburaksener/octoUML/src/view/fxml/edgeEditDialog.fxml"));
    ...
    public boolean showMessageEditDialog(MessageEdge edge) {
        try {
            // Load the classDiagramView.fxml file and create a new stage for the popup
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("com/kaanburaksener/octoUML/src/view/fxml/messageEditDialog.fxml"));
            AnchorPane dialog = loader.load();
            dialog.setBackground(new Background(new BackgroundFill(Color.WHITESMOKE, new CornerRadii(1), null)));
            dialog.setStyle("-fx-border-color: black");
            //Set location for "dialog".
