...
public class Launcher extends Application {
    ...
    public void start(Stage stage) {
        ...
        try {
            loader = new FXMLLoader(getClass().getClassLoader().getResource("com/kaanburaksener/octoUML/src/view/fxml/mainView.fxml"));
            tabView = loader.load();
            tabController = loader.getController();
            loader = new FXMLLoader(getClass().getClassLoader().getResource("com/kaanburaksener/octoUML/src/view/fxml/startView.fxml"));
        ...
        stage.getIcons().add(new Image("com/kaanburaksener/octoUML/src/icons/appIcon.png"));
        stage.show();
