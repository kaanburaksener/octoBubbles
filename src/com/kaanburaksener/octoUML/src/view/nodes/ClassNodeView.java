...
/**
 * Edited by kaanburaksener on 15/02/17.
 **
...
public class ClassNodeView extends AbstractNodeView implements NodeView {
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        } else if (evt.getPropertyName().equals(Constants.changeClassNodeType)) {
            String typeContent = (String) evt.getNewValue();
            if (typeContent == null || typeContent.equals("CLASS")) {
