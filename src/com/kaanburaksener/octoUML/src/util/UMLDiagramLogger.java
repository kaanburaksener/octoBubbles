package com.kaanburaksener.octoUML.src.util;
...
public class UMLDiagramLogger {
    ...
    public void log(Command command, Dot dot){
        ...
        } else if (command instanceof SetNodeValuesCommand){
            logAddValue((SetNodeValuesCommand)command, dot);
        }
    }
    ...
    private void logAddValue(SetNodeValuesCommand command, Dot dot){
        //<DT>  ADD <OBT> <OBID> <OBN> <TRGID> <DOT>
        StringBuilder post = new StringBuilder();
        post.append(System.currentTimeMillis() + "\t"); //DT
        post.append("ADD\t"); //ADD
        post.append("VALUE\t"); //OBT
        post.append("null" + "\t"); //OBID
        post.append(((EnumerationNode)command.getNode()).getValues() + "\t"); //OBN
        post.append(command.getNode().getId() + "\t"); //TRGID
        post.append(dot + "\t"); //DOT
        post.append("\n");
        try {
