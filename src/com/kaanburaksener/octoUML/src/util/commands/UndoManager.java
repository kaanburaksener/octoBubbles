...
import com.kaanburaksener.octoUML.src.util.UMLDiagramLogger;
...
public class UndoManager 
{
	...
	{
		UMLDiagramLogger.log(pCommand, com.kaanburaksener.octoUML.src.util.UMLDiagramLogger.Dot.DO);
		if(!aHoldChanges)
		{
	...
	public void undoCommand()
	{
		...
		UMLDiagramLogger.log(toUndo, com.kaanburaksener.octoUML.src.util.UMLDiagramLogger.Dot.UNDO);
		aHoldChanges = false;
	}
	...
	public void redoCommand()
	{
		...
		UMLDiagramLogger.log(toRedo, com.kaanburaksener.octoUML.src.util.UMLDiagramLogger.Dot.REDO);
		aHoldChanges = false;
	}
